        ...
        <div className="prose prose-zinc dark:prose-invert max-w-none space-y-8">
          <section>
            <p className="text-zinc-700 dark:text-zinc-300">
              ...
              management, pantry tracking, grocery list creation, and the Rechef
              Pro subscription.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="ml-6 mt-2 list-disc space-y-2 text-zinc-700 dark:text-zinc-300">
              <li>
                Email address or other sign-in identifiers (for example via
                Firebase or the app store)
              </li>
              <li>
                Authentication tokens and identifiers used to keep you signed in
                securely
              </li>
              <li>
                Profile information you choose to provide (such as name or
                initials)
              </li>
            </ul>
            ...
            <ul className="ml-6 mt-2 list-disc space-y-2 text-zinc-700 dark:text-zinc-300">
              ...
              <li>
                Product identifiers (for example, monthly or yearly plans)
              </li>
              <li>Renewal status and subscription period</li>
              <li>
                Non-personal transaction metadata provided by the app store
              </li>
            </ul>
            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
            ...
            <ul className="ml-6 mt-2 list-disc space-y-2 text-zinc-700 dark:text-zinc-300">
              <li>
                Recipes you create or save (titles, ingredients, instructions,
                notes, and images)
              </li>
              <li>Pantry items, quantities, and related notes</li>
              <li>
                Grocery lists or shopping-related information generated from
                your pantry or recipes
              </li>
              <li>
                Recipe import data when you submit a URL or content to be parsed
              </li>
            </ul>
            ...
            <ul className="ml-6 mt-2 list-disc space-y-2 text-zinc-700 dark:text-zinc-300">
              ...
              <li>
                Log data (IP address, access times, app version, and pages or
                screens viewed)
              </li>
              <li>
                Feature usage statistics (for example, number of recipe imports
                per month)
              </li>
          ...
          <section>
            ...
            <ul className="ml-6 mt-2 list-disc space-y-2 text-zinc-700 dark:text-zinc-300">
              <li>
                To operate, maintain, and improve the Rechef app and related
                services
              </li>
              <li>
                To sync your recipes, pantry items, and preferences across your
                devices where supported
              </li>
              <li>
                To manage your Rechef Pro subscription, including entitlement
                checks and feature access
              </li>
              <li>
                To process recipe imports from URLs or other supported sources
              </li>
              <li>
                To communicate with you about updates, changes to the Service,
                and important notices
              </li>
              <li>To provide customer support and respond to your inquiries</li>
              <li>
                To monitor usage, protect against misuse or abuse, and detect
          ...
          <section>
            ...
            <ul className="ml-6 mt-2 list-disc space-y-2 text-zinc-700 dark:text-zinc-300">
              ...
              <li>
                Authentication and user account providers (for example,
                Firebase)
              </li>
              <li>
                Subscription and billing infrastructure (for example, RevenueCat
                and app stores)
              </li>
            ...
            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
              ...
              necessary to provide services to us and are expected to protect it
              appropriately.
            </p>
          ...
          <section>
            ...
            <ul className="ml-6 mt-2 list-disc space-y-2 text-zinc-700 dark:text-zinc-300">
              ...
              <li>
                Recipes, pantry items, and related content while you choose to
                keep them in your account
              </li>
              <li>
                Subscription and billing-related records for a period required
                for tax, accounting, or legal purposes
              </li>
              <li>
                Log and analytics data for a reasonable period to improve and
                secure the Service
              </li>
            </ul>
            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
          ...
          <section>
            ...
            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
              Where applicable under local law, you may have the right to access
            ...
            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
              You may be able to delete certain content directly within the app,
              such as recipes or pantry items. You can also request deletion of
            ...
            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
              ...
              marketing emails) by using the unsubscribe link in those messages
              or by adjusting your preferences in the app where available.
            </p>
          ...
          <section>
            ...
            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
              Rechef is not intended for use by children under the age of 13 (or
          ...
          <section>
            ...
            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
              We may use cookies or similar technologies in our web experiences
              to help remember your preferences, keep you signed in, and
              understand how the Service is used. You can usually control
          ...
          <section>
            ...
            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
              ...
              different data protection laws than your own. Where required by
              law, we will take appropriate steps to ensure that your personal
          ...
          <section>
            ...
            <p className="mt-2 text-zinc-700 dark:text-zinc-300">
              ...
              Service after any changes signifies your acceptance of the updated
              policy.
            </p>
          </section>
