#!/usr/bin/env node
/**
 * Run only the cookbook tables migration (0007).
 * Usage: node scripts/run-cookbook-migration.mjs
...
async function run() {
  console.log("Running cookbook tables migration...");
